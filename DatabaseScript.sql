...
CREATE TABLE LEASES(
    ...
    LOCATION_NUM INT CONSTRAINT LEASES_LOCATION_NUM_NOTNULL NOT NULL
);
...
CREATE TABLE LEASE_REQUESTS(
    ...
    LOCATION_NUM INT CONSTRAINT LEASE_REQS_LOC_NUM_NOTNULL NOT NULL,
...
CREATE TABLE APPOINTMENTS(
    ...
    LOCATION_NUM INT CONSTRAINT APP_LOCATION_NUM_NOTNULL NOT NULL,
...
CREATE TABLE PROPERTIES(
    NAME VARCHAR(100),
    LOCATION_NUM INT CONSTRAINT PROPERTIES_LOCATION_NUM_PK PRIMARY KEY,
...
CREATE TABLE LOCS(
    LOCATION_NUM INT CONSTRAINT LOCATIONS_LOCATION_NUM_PK PRIMARY KEY,
    MALL_NUM INT CONSTRAINT LOCATIONS_MALL_NUM_NOTNULL NOT NULL,
 /*[GFSHO] --> GROUND/FIRST/SECOND/THIRD/FOURTH FLOORS*/
    STORE_NUM VARCHAR(10) CONSTRAINT LOCATIONS_STORE_NUM_FORM CHECK (REGEXP_LIKE(STORE_NUM, '^[GFSHO]\d+')) CONSTRAINT LOCATIONS_STORE_NUM_NOTNULL NOT NULL,
    CONSTRAINT LOCATIONS_UNIQUENESS UNIQUE(MALL_NUM, STORE_NUM)
);

CREATE TABLE MALLS(
    MALL_NUM INT CONSTRAINT MALLS_MALL_NUM_PK PRIMARY KEY,
    NAME VARCHAR(100) CONSTRAINT MALLS_NAME_UNIQUE UNIQUE,
    ADDRESS VARCHAR(200) CONSTRAINT MALLS_ADDRESS_NOTNULL NOT NULL,
    NUM_FLOORS INT CONSTRAINT MALLS_NUM_FLOORS_RANGE CHECK (NUM_FLOORS BETWEEN 0 AND 3)
);
