...
public class PropertyBrowsingFilters extends javax.swing.JPanel implements FilterPane {
    ...
    private void initComponents() {
        ...
        checkBoxC.setText("C");
        checkBoxC.setMaximumSize(new java.awt.Dimension(31, 20));
        checkBoxC.setMinimumSize(new java.awt.Dimension(31, 20));

        checkBoxD.setText("D");
        checkBoxD.setMaximumSize(new java.awt.Dimension(31, 20));
        checkBoxD.setMinimumSize(new java.awt.Dimension(31, 20));
